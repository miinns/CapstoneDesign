...
# Oracle 데이터베이스 연결 설정
db_conn = oracledb.connect(user="C##Sound", password="1234", dsn="localhost:1521/xe")
...
class Ui_Login(object):
    ...
    def show_type_page_dogbark(self):
        ...
        # 버튼 클릭 이벤트 연결
        self.type_page_dogbark_ui.pushButton.clicked.connect(lambda: self.save_pattern_dog('pattern1'))
        self.type_page_dogbark_ui.pushButton_2.clicked.connect(lambda: self.save_pattern_dog('pattern2'))
        self.type_page_dogbark_ui.pushButton_3.clicked.connect(lambda: self.save_pattern_dog('pattern3'))
        self.type_page_dogbark_ui.pushButton_4.clicked.connect(lambda: self.save_pattern_dog('pattern4'))
        self.type_page_dogbark_ui.pushButton_5.clicked.connect(lambda: self.save_pattern_dog('pattern5'))
        self.type_page_dogbark_ui.pushButton_6.clicked.connect(lambda: self.save_pattern_dog('pattern6'))

        self.type_page_dogbark_ui.check_button.clicked.connect(self.hide_type_page_dogbark)

    def save_pattern_dog(self, pattern_name):
        if self.logged_in_user_id:
            try:
                cursor = db_conn.cursor()
                cursor.execute(
    ...
    def show_type_page_firealarm(self):
        ...
        # 버튼 클릭 이벤트 연결
        self.type_page_firealarm_ui.pushButton.clicked.connect(lambda: self.save_pattern_fire('pattern1'))
        self.type_page_firealarm_ui.pushButton_2.clicked.connect(lambda: self.save_pattern_fire('pattern2'))
        self.type_page_firealarm_ui.pushButton_3.clicked.connect(lambda: self.save_pattern_fire('pattern3'))
        self.type_page_firealarm_ui.pushButton_4.clicked.connect(lambda: self.save_pattern_fire('pattern4'))
        self.type_page_firealarm_ui.pushButton_5.clicked.connect(lambda: self.save_pattern_fire('pattern5'))
        self.type_page_firealarm_ui.pushButton_6.clicked.connect(lambda: self.save_pattern_fire('pattern6'))

        self.type_page_firealarm_ui.check_button.clicked.connect(self.hide_type_page_firealarm)

    def save_pattern_fire(self, pattern_name):
        if self.logged_in_user_id:
            try:
                cursor = db_conn.cursor()
                cursor.execute(
